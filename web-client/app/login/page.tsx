...
import { Video, Loader2, Github, Facebook, AlertCircle, CheckCircle } from 'lucide-react';
...
function LoginContent() {
  ...
  return (
    <div className="w-full max-w-md bg-[#131926] border border-white/10 rounded-3xl p-8 shadow-2xl backdrop-blur-xl relative z-10">
      ...
      {registered && (
        <div className="mb-6 p-4 bg-green-500/10 border border-green-500/20 rounded-xl flex items-center gap-3 text-green-400 text-sm animate-in fade-in slide-in-from-top-2">
      ...
      <div className="relative mb-8">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-[#131926] px-4 text-slate-500">Or sign in with email</span>
        </div>
      </div>
